...
import com.pablobuendia.universitymanager.error.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @Value("${com.pablo.trace.enabled:false}")
  ...
  public ResponseEntity<Object> handleItemNotFoundException(
    ...
    log.error("Failed to find the requested element: ", elementNotFoundException);
